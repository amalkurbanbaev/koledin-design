        ...
        <Transition appear show={isOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={handleClose}>
                <Transition.Child
                    ...
                    leaveTo="opacity-0"
                >
                    <div className="fixed inset-0 bg-white/80 backdrop-blur-[5px] dark:bg-black/90" />
                </Transition.Child>
                ...
                <div className="scrollbar-themed fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="relative w-full max-w-6xl rounded-2xl bg-transparent pb-20 pt-5 text-left align-middle transition-all dark:shadow-xl landscape:pt-4">
                                <Image
                                    alt="Close project"
                                    src={AdditionalLogo}
                                    width={73}
